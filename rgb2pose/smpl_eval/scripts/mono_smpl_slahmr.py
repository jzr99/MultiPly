...
EXP_path_list = [
    ...
    # '/media/ubuntu/hdd/CLIFF/test_samples/pair17_dance17_28',
    # '/media/ubuntu/hdd/slahmr/pair15_fight15_4-all-shot-0-0-180_4',
    '/media/ubuntu/hdd/slahmr/pair17_dance17_28-all-shot-0-0-180_28',
]
    ...
    for pair in args.pairs:
        ...
        for action in actions:
            ...
            for PRED_PATH in EXP_path_list:
                ...
                pred_root = os.path.join(PRED_PATH, 'all.npz')
                pred = np.load(pred_root, allow_pickle=True)

                for pred_idx, i in enumerate(trange(evaluator.start, evaluator.end+1)):
                # for pred_idx, i in enumerate(trange(evaluator.start, evaluator.start+1)):
                    ...
                    pred_cam_trans = np.zeros((pred_joints_3d.shape[0], 3))
