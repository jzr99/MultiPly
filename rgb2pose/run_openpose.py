...
try:
    ...
    parser.add_argument("--image_dir", default="/home/chen/disk2/MPI_INF_Dataset/DeepCapDataset/Marc_1/frames", help="Process a directory of images. Read all standard formats (jpg, png, bmp, etc.).")
