...
try:
    ...
    parser.add_argument("--image_dir", default="/home/chen/disk2/Youtube_Videos/otmar/frames", help="Process a directory of images. Read all standard formats (jpg, png, bmp, etc.).")
