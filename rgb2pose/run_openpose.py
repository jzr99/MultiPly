...
try:
    ...
    parser.add_argument("--image_dir", default="/home/chen/disk2/MPI_INF_Dataset/MonoPerfCapDataset/Nadia_outdoor/frames", help="Process a directory of images. Read all standard formats (jpg, png, bmp, etc.).")
