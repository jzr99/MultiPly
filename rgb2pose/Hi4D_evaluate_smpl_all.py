...
DATA_DIR = "/media/ubuntu/hdd/V2A_output/data"
DIR = '/media/ubuntu/hdd/V2A_output/'
GT_DIR = "/media/ubuntu/hdd/Hi4D_gt"
...
for conf in test_conf:
    ...
    for person_id in person_id_list:
        smpl_model = SMPL('/media/ubuntu/hdd/V2A_output/data/smpl', gender=gender_list[person_id]).to(device)
