...
checkpoint = torch.load('/home/chen/RGB-PINA/code/outputs/ThreeDPW/Invisible_off_weight_2_w_opt_smpl_0.2/checkpoints/epoch=0549-loss=0.013226576149463654.ckpt')
...
for i in trange(global_orient.shape[0]):
    ...
    cv2.imwrite(os.path.join(f'/home/chen/RGB-PINA/code/outputs/ThreeDPW/Invisible_off_weight_2_w_opt_smpl_0.2/joint_opt_smpl_549', '%04d.png' % i), output_img)