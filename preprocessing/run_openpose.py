...
def main(args):
    try:
        ...
        for idx, imagePath in enumerate(imagePaths):
            ...
            # mask_center = get_mask_center(maskPath)
            datum.cvInputData = imageToProcess
            opWrapper.emplaceAndPop(op.VectorDatum([datum]))

            poseKeypoints = datum.poseKeypoints
            # TODO using weighted average not the only point!
            ...
            # actor = nbrs.kneighbors(mask_center.reshape(1, -1), return_distance=False).ravel()[0]
