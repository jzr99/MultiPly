...
seq = 'outdoors_fencing_01_GT'
if seq == 'outdoors_fencing_01':
    start_idx = 0
if seq == 'outdoors_fencing_01_GT':
    start_idx = 546

gt_mesh_dir = f'/home/chen/disk2/3DPW_GT/outdoors_fencing_01/mesh'
...
# selfrecon_mesh_w_est_pose_dir = f'/home/chen/SelfReconCode/data/{seq}/result/final_meshes_transformed'
# icon_mesh_w_est_pose_dir = f'/home/chen/disk2/ICON_new_results/test_mesh'
...
for idx, our_mesh_w_est_pose_path in tqdm(enumerate(ours_mesh_w_ori_pose_paths)):
    ...
    ours_mesh_w_ori_pose = trimesh.load(ours_mesh_w_ori_pose_paths[idx], process=False)
    ...
    selfrecon_dict = compute_metric(selfrecon_mesh_w_ori_pose, gt_mesh)
    # icon_dict = compute_metric(icon_mesh_w_ori_pose, gt_mesh)
    # ours_wo_opt_smpl_dict = compute_metric(ours_mesh_wo_opt_smpl, gt_mesh)
    ours_w_ori_pose_dict = compute_metric(ours_mesh_w_ori_pose, gt_mesh)
    ...
    ours_wo_bg_cd.append(ours_w_ori_pose_dict['chamfer'])
    ...
    ours_wo_bg_nc.append(ours_w_ori_pose_dict['nc'])
