...
if __name__ == "__main__":
    ...
    skip_step = 2
    normalize_shift = 0.
    end_idx = 30 # exclude the later frames due to the dirty data
    ...
    for idx, file_path in enumerate(files):
        ...
        for i, (render_img, render_depth) in enumerate(zip(render_imgs, render_depths)):
            ...
            os.makedirs(f"outputs/depth_cam{i:02d}", exist_ok=True)
            ...
            np.save(f"outputs/depth_cam{i:02d}/depth_{frame:04d}.npy", render_depth)
