...
@hydra.main(config_path="confs", config_name="Hi4D_pair15_fight15_4_loop_vitpose_2_noshare_base")
def main(opt):
    ...
    trainer.test(model, testset, ckpt_path="checkpoints/epoch=1099-loss=0.010748645290732384.ckpt")
