...
@hydra.main(config_path="confs", config_name="Hi4D_pair17_dance17_28_sam_delay_depth_loop_base")
def main(opt):
    ...
    trainer.test(model, testset, ckpt_path="checkpoints/epoch=3649-loss=0.00982195045799017.ckpt")
