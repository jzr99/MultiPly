...
@hydra.main(config_path="confs", config_name="updown_sam_delay_depth_loop_noshare_vitpose_openpose_base")
def main(opt):
    ...
    trainer.test(model, testset, ckpt_path="checkpoints/epoch=1499-loss=0.014361904002726078.ckpt")
