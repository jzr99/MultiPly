...
@hydra.main(config_path="confs", config_name="walk3_sam_delay_depth_loop_MLP_base")
def main(opt):
    ...
    trainer.test(model, testset, ckpt_path="checkpoints/epoch=1949-loss=0.02211214229464531.ckpt")
