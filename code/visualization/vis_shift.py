...
image_writer = imageio.get_writer(os.path.join(seq_dir, 'ep1_1.mp4'), fps=30)
overlay_normal_writer = imageio.get_writer(os.path.join(seq_dir, 'ep1_2.mp4'), fps=30)
rotate_normal_writer = imageio.get_writer(os.path.join(seq_dir, 'ep1_3.mp4'), fps=30)
