...
image_paths = sorted(glob.glob('/home/chen/RGB-PINA/data/Wildmotion1/image/*.png'))
ours_paths = sorted(glob.glob('/home/chen/RGB-PINA/code/outputs/ThreeDPW/Wildmotion1_wo_disp_freeze_20_every_20_opt_pose/test_overlay_normal/*.png'))
icon_paths = sorted(glob.glob('/home/chen/disk2/ICON_new_results/Wildmotion1/icon-filter/recon_overlay/*.png'))
selfrecon_paths = sorted(glob.glob('/home/chen/disk2/SelfRecon_results/Wildmotion1/result/meshs/*.png'))
seq_dir = '/home/chen/RGB-PINA/code/outputs/ThreeDPW/Wildmotion1_wo_disp_freeze_20_every_20_opt_pose'
