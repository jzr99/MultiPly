...
@hydra.main(config_path="confs", config_name="Matt3_sam_delay_depth_loop_base")
def main(opt):
    ...
    trainer.test(model, testset, ckpt_path="checkpoints/epoch=1049-loss=0.020872177556157112.ckpt")
