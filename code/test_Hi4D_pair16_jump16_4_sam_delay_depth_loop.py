...
@hydra.main(config_path="confs", config_name="Hi4D_pair16_jump16_4_sam_delay_depth_loop_base")
def main(opt):
    ...
    trainer.test(model, testset, ckpt_path="checkpoints/epoch=4699-loss=0.009985905140638351.ckpt")
