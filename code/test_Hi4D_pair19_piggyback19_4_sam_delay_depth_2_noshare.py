...
@hydra.main(config_path="confs", config_name="Hi4D_pair19_piggyback19_4_sam_delay_depth_2_noshare_base")
def main(opt):
    ...
    trainer.test(model, testset, ckpt_path="checkpoints/epoch=2199-loss=0.008438586257398129.ckpt")
