...
@hydra.main(config_path="confs", config_name="taichi03_sam_delay_depth20_loop_2_0pose_MLP_expand_vitpose_openpose_base")
def main(opt):
    ...
    trainer.test(model, testset, ckpt_path="checkpoints/epoch=3899-loss=0.023940810933709145.ckpt")
