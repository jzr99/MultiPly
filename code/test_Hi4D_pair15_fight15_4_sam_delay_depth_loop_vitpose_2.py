...
@hydra.main(config_path="confs", config_name="Hi4D_pair15_fight15_4_sam_delay_depth_loop_vitpose_2_base")
def main(opt):
    ...
    trainer.test(model, testset, ckpt_path="checkpoints/epoch=1099-loss=0.010885542258620262.ckpt")
