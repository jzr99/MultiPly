...
@hydra.main(config_path="confs", config_name="Dragon_sam_delay_depth_loop_MLP_base")
def main(opt):
    ...
    trainer.test(model, testset, ckpt_path="checkpoints/epoch=1649-loss=0.013030702248215675.ckpt")
