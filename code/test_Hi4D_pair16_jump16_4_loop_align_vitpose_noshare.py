...
@hydra.main(config_path="confs", config_name="Hi4D_pair16_jump16_4_loop_align_vitpose_noshare_base")
def main(opt):
    ...
    trainer.test(model, testset, ckpt_path="checkpoints/epoch=1049-loss=0.017798202112317085.ckpt")
