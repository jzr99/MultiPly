...
@hydra.main(config_path="confs", config_name="Hi4D_pair17_dance17_28_sam_delay_depth_loop_0pose_base")
def main(opt):
    ...
    trainer.test(model, testset, ckpt_path="checkpoints/epoch=1299-loss=0.012538536451756954.ckpt")
