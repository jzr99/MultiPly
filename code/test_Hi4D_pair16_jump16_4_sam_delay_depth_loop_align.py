...
@hydra.main(config_path="confs", config_name="Hi4D_pair16_jump16_4_sam_delay_depth_loop_align_base")
def main(opt):
    ...
    trainer.test(model, testset, ckpt_path="checkpoints/epoch=3749-loss=0.010910226963460445.ckpt")
