...
@hydra.main(config_path="confs", config_name="Hi4D_pair15_fight15_4_sam_delay_depth_loop_align_base")
def main(opt):
    ...
    trainer.test(model, testset, ckpt_path="checkpoints/epoch=3049-loss=0.011147837154567242.ckpt")
