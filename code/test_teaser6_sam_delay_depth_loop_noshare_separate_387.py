...
@hydra.main(config_path="confs", config_name="teaser6_sam_delay_depth_loop_noshare_base")
def main(opt):
    ...
    trainer.test(model, testset, ckpt_path="checkpoints/epoch=0999-loss=0.026089750230312347.ckpt")
