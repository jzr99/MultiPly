...
@hydra.main(config_path="confs", config_name="taichi03_sam_delay_depth20_loop_2_0pose_base")
def main(opt):
    ...
    trainer.test(model, testset, ckpt_path="checkpoints/epoch=4499-loss=0.028352759778499603.ckpt")
