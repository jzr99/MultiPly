...
@hydra.main(config_path="confs", config_name="taichi03_sam_delay_depth_loop_2_MLP_base")
def main(opt):
    ...
    trainer.test(model, testset, ckpt_path="checkpoints/epoch=3699-loss=0.02028140425682068.ckpt")
