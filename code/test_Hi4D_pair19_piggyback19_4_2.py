...
@hydra.main(config_path="confs", config_name="Hi4D_pair19_piggyback19_4_2_base")
def main(opt):
    ...
    trainer.test(model, testset, ckpt_path="checkpoints/epoch=1049-loss=0.013413563370704651.ckpt")
