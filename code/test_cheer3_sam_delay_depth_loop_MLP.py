...
@hydra.main(config_path="confs", config_name="cheer3_sam_delay_depth_loop_MLP_base")
def main(opt):
    ...
    trainer.test(model, testset, ckpt_path="checkpoints/epoch=1549-loss=0.04393467679619789.ckpt")
