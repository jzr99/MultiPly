...
@hydra.main(config_path="confs", config_name="taichi01_sam_delay_depth_loop_2_base")
def main(opt):
    ...
    trainer.test(model, testset, ckpt_path="checkpoints/epoch=3949-loss=0.025581873953342438.ckpt")
