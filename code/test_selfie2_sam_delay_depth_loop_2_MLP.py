...
@hydra.main(config_path="confs", config_name="selfie2_sam_delay_depth_loop_2_MLP_base")
def main(opt):
    ...
    trainer.test(model, testset, ckpt_path="checkpoints/epoch=2249-loss=0.027535097673535347.ckpt")
