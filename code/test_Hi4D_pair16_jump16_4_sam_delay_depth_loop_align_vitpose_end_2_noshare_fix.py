...
@hydra.main(config_path="confs", config_name="Hi4D_pair16_jump16_4_sam_delay_depth_loop_align_vitpose_end_2_noshare_fix_base")
def main(opt):
    ...
    trainer.test(model, testset, ckpt_path="checkpoints/epoch=1049-loss=0.01794184185564518.ckpt")
