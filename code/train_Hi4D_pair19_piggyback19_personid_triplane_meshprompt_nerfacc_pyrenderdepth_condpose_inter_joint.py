...
@hydra.main(config_path="confs", config_name="Hi4D_pair19_piggyback19_cam04_loop_depth_samGT_personid_triplane_meshprompt_nerfacc_pyrenderdepth_condpose_inter_joint_base")
def main(opt):
