...
@hydra.main(config_path="confs", config_name="Hi4D_pair19_piggyback19_4_sam_delay_depth_2_noshare_fix_base")
def main(opt):
    ...
    trainer.test(model, testset, ckpt_path="checkpoints/epoch=1299-loss=0.014385057613253593.ckpt")
