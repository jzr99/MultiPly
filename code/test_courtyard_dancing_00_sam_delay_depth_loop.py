...
@hydra.main(config_path="confs", config_name="courtyard_dancing_00_sam_delay_depth_loop_base")
def main(opt):
    ...
    trainer.test(model, testset, ckpt_path="checkpoints/epoch=2649-loss=0.06159542500972748.ckpt")
