...
@hydra.main(config_path="confs", config_name="Hi4D_pair19_piggyback19_4_sam_delay_depth_2_noshare_sam_high_base")
def main(opt):
    ...
    trainer.test(model, testset, ckpt_path="checkpoints/epoch=0899-loss=0.014523206278681755.ckpt")
