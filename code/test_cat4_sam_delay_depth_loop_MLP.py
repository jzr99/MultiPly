...
@hydra.main(config_path="confs", config_name="cat4_sam_delay_depth_loop_MLP_base")
def main(opt):
    ...
    trainer.test(model, testset, ckpt_path="checkpoints/epoch=1349-loss=0.024125998839735985.ckpt")
