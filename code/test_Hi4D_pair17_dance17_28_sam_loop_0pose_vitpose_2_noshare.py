...
@hydra.main(config_path="confs", config_name="Hi4D_pair17_dance17_28_sam_loop_0pose_vitpose_2_noshare_base")
def main(opt):
    ...
    trainer.test(model, testset, ckpt_path="checkpoints/epoch=1049-loss=0.011161203496158123.ckpt")
