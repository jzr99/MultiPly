...
@hydra.main(config_path="confs", config_name="cvpr_sam_delay_depth_loop_MLP_base")
def main(opt):
    ...
    trainer.test(model, testset, ckpt_path="checkpoints/epoch=1199-loss=0.02682671509683132.ckpt")
