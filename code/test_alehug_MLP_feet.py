...
@hydra.main(config_path="confs", config_name="alehug_MLP_feet_base")
def main(opt):
    ...
    trainer.test(model, testset, ckpt_path="checkpoints/epoch=1399-loss=0.041695840656757355.ckpt")
