...
@hydra.main(config_path="confs", config_name="sit2_sam_delay_depth_loop_2_MLP_base")
def main(opt):
    ...
    trainer.test(model, testset, ckpt_path="checkpoints/epoch=3099-loss=0.03412926569581032.ckpt")
