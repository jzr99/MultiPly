...
@hydra.main(config_path="confs", config_name="Hi4D_pair17_dance17_28_loop_0pose_vitpose_2_base")
def main(opt):
    ...
    trainer.test(model, testset, ckpt_path="checkpoints/epoch=1049-loss=0.00981885101646185.ckpt")
