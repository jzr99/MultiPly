...
@hydra.main(config_path="confs", config_name="cycle_dance_sam_ratio75_base")
def main(opt):
    ...
    trainer.test(model, testset, ckpt_path="checkpoints/epoch=0399-loss=0.042261961847543716.ckpt")
