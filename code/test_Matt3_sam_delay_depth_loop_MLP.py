...
@hydra.main(config_path="confs", config_name="Matt3_sam_delay_depth_loop_MLP_base")
def main(opt):
    ...
    trainer.test(model, testset, ckpt_path="checkpoints/epoch=1049-loss=0.019771438091993332.ckpt")
