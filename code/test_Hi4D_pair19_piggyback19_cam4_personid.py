...
@hydra.main(config_path="confs", config_name="Hi4D_pair19_piggyback19_cam04_loop_surface2_depth_samGT_personid_base")
def main(opt):
    ...
    trainer.test(model, testset, ckpt_path="checkpoints/last-v2.ckpt")
