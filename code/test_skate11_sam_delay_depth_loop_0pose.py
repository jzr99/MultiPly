...
@hydra.main(config_path="confs", config_name="skate11_sam_delay_depth_loop_0pose_base")
def main(opt):
    ...
    trainer.test(model, testset, ckpt_path="checkpoints/epoch=1999-loss=0.019447624683380127.ckpt")
