...
@hydra.main(config_path="confs", config_name="Dragon_sam_delay_depth_loop_base")
def main(opt):
    ...
    trainer.test(model, testset, ckpt_path="checkpoints/epoch=0949-loss=0.013851629570126534.ckpt")
