...
@hydra.main(config_path="confs", config_name="dance5_sam_delay_depth_loop_noshare_base")
def main(opt):
    ...
    trainer.test(model, testset, ckpt_path="checkpoints/epoch=1599-loss=0.02627916820347309.ckpt")
