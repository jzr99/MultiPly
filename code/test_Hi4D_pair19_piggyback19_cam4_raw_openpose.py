...
@hydra.main(config_path="confs", config_name="Hi4D_pair19_piggyback19_cam04_raw_openpose_base")
def main(opt):
    ...
    trainer.test(model, testset, ckpt_path="checkpoints/epoch=1299-loss=0.013678018935024738.ckpt")
